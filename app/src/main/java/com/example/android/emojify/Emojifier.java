...
class Emojifier {
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Timber.i("whichEmoji: smilingProb = " + face.getIsSmilingProbability());
        Timber.i("whichEmoji: leftEyeOpenProb = " + face.getIsLeftEyeOpenProbability());
        Timber.i("whichEmoji: rightEyeOpenProb = " + face.getIsRightEyeOpenProbability());
        ...
        Timber.i("whichEmoji: " + emoji.name());
